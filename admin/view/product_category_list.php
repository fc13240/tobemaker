										...
										<ul class="dropdown-menu pull-right">
											...
											<li>
												...
												Export to Excel </a>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="idea_list_table" data-url="<?=BASE_URL?>api/product_category.php">
							<thead>
							<tr>
...
<script src="./assets/user/pages/scripts/product_category_list.js"></script>
<script>
