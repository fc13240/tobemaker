...
<div id="center">
    <div class="middle-margin">
        ...
        <div class="content list">
            ...
            <dl>
                <dd><a href="#"><img src="asset/13.png" alt=""></a></dd>
        ...
        <div id="comming-pagenum" class="pagenum" data-url="<?=BASE_URL."api/project_list.php"?>">
            <a href="#">1</a>
            <a href="#">2</a>
            <a href="#">3</a>
            <a href="#">4</a>
...
<script type="text/javascript" charset="utf-8">
    ...
    function loadIdeaPage(current_page){
        ...
        var length = pageSize;
        var url = $('#comming-pagenum').data("url");
        $.post(url, {"start":start, "length":length, "type":"produce", "user_id":1}, function(data, textStatus){
          //  console.log(data);
    ...
    $("#comming-pagenum").on("click","a",function(){
