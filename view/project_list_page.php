            ...
            <div class="form border dark">
                <div class="weixin">
                    ...
                    <p>用微信<span>扫一扫</span>上方的二维码，
                        ...
                        即可分享给您的微信好友或朋友圈。</p>
<!--                    <p>
                        <wb:share-button id="weibo_true_body" style="width:95px;position: relative;left: 20px;" appkey="4SkNjA" addition="number" type="button" ralateUid="5285964905" default_text="" pic=""></wb:share-button>
                    </p>-->
                </div>
            ...
            function loadIdeaPage(current_page, move_type) {
                ...
                $.post(url, {
                    ...
                    for (var i = 0; data.data != undefined && i < data.data.length; i++) {
                        ...
                        $container.append('\
                    <dl>\
                        <dd><a href="project.php?idea_id=' + item.idea_id + '"><img src="' + (item['picture_url'] == undefined ? 'asset/12.png' : item['picture_url']) + '?imageMogr/v2/thumbnail/318x273!" class="h273" alt=""></a></dd>\
...
//                        $('#weibo_true_body').attr('default_text', $(this).data('content'));
//                        $('#weibo_true_body').attr('pic', $(this).data('pic'));
                    });
