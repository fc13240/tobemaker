<div class="top">
    <div class="middle">
        ...
        <div class="lgn">
            <a href="person.php" target="_top" id="minebtn"><img src="<?php echo $current_user['head_url'] == '' ? 'asset/12.png' : $current_user['head_url']; ?>?imageMogr/v2/thumbnail/22x22!" alt="<?=$current_user['user_name']?>"></a>
